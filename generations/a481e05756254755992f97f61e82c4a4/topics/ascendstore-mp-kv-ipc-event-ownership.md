...
| 状态 | **OPEN**；**isDraft=true**；mergeable **MERGEABLE**；mergeStateStatus **BLOCKED** |
| base / head 分支 | `main` / `feat/ascend-store-transfer-mp` |
| **base SHA** | `cdad5a32e0a0cc0232ae29ded29636162f4fb690` |
| **head SHA** | `22c8c589ec55976d5f77154f7655ffe53db10431` |
| 作者 | `ChenZhuo888` |
| labels | `ci/build`, `module:tests`, `module:tools`, `ready-precise` |
| 规模 | +5707 / −15，**33 files** |
| 对比（本轮） | https://github.com/vllm-project/vllm-ascend/compare/cdad5a32e0a0cc0232ae29ded29636162f4fb690...22c8c589ec55976d5f77154f7655ffe53db10431 |
| 对比（旧 tip 永久） | https://github.com/vllm-project/vllm-ascend/compare/660c4582aa580ce98edc9b681bb6ff6d03153575...cea32e97544a2f3f73d5c5310569077912963bd0 |
