...
- **Pinned（本轮 gh）**: base `26f1363f7180dfcbeac1230679976cede6010fc8` · head `e396378001f37be2b0ec785e14e6735ee5f6e683`
...
- base `main` @ `26f1363f…`；head `reuse-vllm-ec-mooncake` @ `e3963780…`。
...
**条件**: head `e396378001f37be2b0ec785e14e6735ee5f6e683`；OPEN blocked；V2 不在范围。
