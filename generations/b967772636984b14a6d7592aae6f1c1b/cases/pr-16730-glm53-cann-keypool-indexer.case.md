...
- **来源 PR**: https://github.com/vllm-project/vllm-ascend/pull/16730 （author `lijiahang226`；labels: `module:tests`）
- **Pinned（本轮 gh 2026-09-17）**: base `e1d1490314eeb5baec2e77b27a9610e5358aa153` · head `0c7c2dc59bf707a4464526e4be3bf74fb1ccd148`
...
- base `main` @ `e1d14903…`；head @ `0c7c2dc5…`。
...
**条件**: head `0c7c2dc59bf707a4464526e4be3bf74fb1ccd148`；OPEN blocked；无 device tests。
