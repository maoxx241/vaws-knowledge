...
- **Pinned（本轮 gh）**: base `90b5dd80d0180c4ddfe6d46a252d93d632b3c16b` · head `cf795e72494ce8690a6bf8d3384463fa306b6b95`
...
- 仓库：`vllm-project/vllm-ascend`；base `main` @ `90b5dd80…`；head `perf/fuse-dspark-swa-indices-triton` @ `cf795e72…`。
...
**条件**: head `cf795e72494ce8690a6bf8d3384463fa306b6b95`；OPEN blocked；无用户可见 API 变更（PR CLAIM）。
...
- Compare: https://github.com/vllm-project/vllm-ascend/compare/90b5dd80d0180c4ddfe6d46a252d93d632b3c16b...cf795e72494ce8690a6bf8d3384463fa306b6b95
- Related AscendC route: https://github.com/vllm-project/vllm-ascend/pull/15626
- Head blob kernel: https://github.com/vllm-project/vllm-ascend/blob/cf795e72494ce8690a6bf8d3384463fa306b6b95/vllm_ascend/ops/triton/dspark_swa_indices.py
