...
```python
from vaws_knowledge.code_map import build_code_map, navigate, compare_maps
...
`.git`, `.vaws-local`, environments, build output and common generated folders.
...
```python
from vaws_knowledge.relations import build_relations, backlinks, affected_documents
