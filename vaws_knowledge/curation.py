...
from vaws_knowledge.markdown import meta_path, normalized_sha256, parse_markdown, uri_for
...
def main(argv: list[str] | None = None) -> int:
    ...
    from vaws_knowledge.server.layers import ConfigError, load_config
