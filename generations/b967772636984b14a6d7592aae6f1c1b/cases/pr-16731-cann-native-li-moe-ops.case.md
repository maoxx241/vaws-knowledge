...
- **Pinned（本轮 gh 2026-09-17）**: base `e1d1490314eeb5baec2e77b27a9610e5358aa153` · head `0a16733161a65da4e30a5c7f7030500b0bfc7cac`
...
- base `main` @ `e1d14903…`；head @ `0a167331…`。
...
**条件**: head `0a16733161a65da4e30a5c7f7030500b0bfc7cac`；OPEN blocked；正确性 **CLAIM**。
