...
YAML loading and CLI exit codes remain owned by vaws-knowledge.
"""
from __future__ import annotations
import sys
from pathlib import Path
from typing import Sequence
from vaws_diagnostics import redact as _shared
from vaws_diagnostics.redact import (Rule, Finding, RULES, RULE_IDS, REDACTION_PROFILE,
    BUILTIN_ALLOWLIST, BUILTIN_ALLOW_PATTERNS, scan_text, scan_tree, redact_text)
from vaws_knowledge._common import (EXIT_FINDINGS, EXIT_OK, ToolError,
