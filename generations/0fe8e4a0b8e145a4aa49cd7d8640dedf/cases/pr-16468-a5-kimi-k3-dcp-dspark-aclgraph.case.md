...
- **状态**: OPEN **draft** / **CONFLICTING·DIRTY** / reference-only；超大 PR（+66k/−337，292 files）
...
- **Pinned（本轮 gh 2026-09-16）**: base `c267db731d03e18042047ea1594e033673e46a6f` · head `4e519623bbd12a3daf1a9555ce63b1d44e9ce867`
...
- base `main` @ `c267db73…`；head `feat/rfc16464-a5-kimi-k3-flash-mla` @ `4e519623…`。
...
**条件**: head `4e519623bbd12a3daf1a9555ce63b1d44e9ce867`；**OPEN draft** + DIRTY；experimental / not-intended-to-merge（PR CLAIM）。
