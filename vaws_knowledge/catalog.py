...
from vaws_knowledge.distribution.errors import DistributionError, SwitchInProgress
from vaws_knowledge.distribution.sync import SwitchLock
from vaws_knowledge.local.backend import Hit
from vaws_knowledge.markdown import Document, LAYERS, MAX_METADATA_BYTES, MAX_REFERENCE_BYTES, document_from_text, meta_path, normalized_sha256, read_bounded, retrieval_aliases, uri_for
from vaws_knowledge.retrieval import tokens
            ...
            for layer in LAYERS:
                ...
                for root in mount.roots:
                    ...
                    try:
                        ...
                        from vaws_knowledge.health import _markdown_paths
    ...
    try:
        ...
        if extra_documents is None:
            ...
            if current and current.get("prepared_root"):
                from vaws_knowledge.distribution.references import prepared_shared_documents
